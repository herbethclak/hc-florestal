...
// Sobrescreve o authDomain para usar o domínio do Vercel onde o app está hospedado
const config = {
  ...firebaseConfig,
  authDomain: 'hc-florestal.vercel.app',
};
...
console.log('Firebase initialization:', {
  ...
  apiKeyStart: config?.apiKey?.substring(0, 5)
});
